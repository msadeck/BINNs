    ...
    def fit(self,
        ...
        if callbacks is not None:
            for c in callbacks:
                if hasattr(c, 'on_train_begin'):
                    c.on_train_begin(self)  # ✅ correct method call
        ...
        for epoch in range(initial_epoch, initial_epoch + epochs):
            ...
            if callbacks is not None:
                for c in callbacks:
                    if hasattr(c, 'on_epoch_begin'):
                        c.on_epoch_begin(self)  # ✅ correct method call
            ...
            for idx in range(train_batches_per_epoch):
                ...
                if callbacks is not None:
                    for c in callbacks:
                        if hasattr(c, 'on_batch_begin'):
                            c.on_batch_begin(self)
                ...
                if callbacks is not None:
                    for c in callbacks:
                        if hasattr(c, 'on_batch_end'):
                            c.on_batch_end(self)  # ✅ correct method call
            ...
            if validation_data is not None:
                ...
                for idx in range(val_batches_per_epoch):
                    ...
                    if callbacks is not None:
                        for c in callbacks:
                            if hasattr(c, 'on_batch_begin'):
                                c.on_batch_begin(self)  # ✅ correct method call
            ...
            if callbacks is not None:
                for c in callbacks:
                    if hasattr(c, 'on_epoch_end'):
                        c.on_epoch_end(self)  # ✅ correct method call
        ...
        if callbacks is not None:
            for c in callbacks:
                if hasattr(c, 'on_train_end'):
                    c.on_train_end(self)  # ✅ correct method call
